...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-lg"><b>Mantelzorg</b> Backend</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Alle artikelen</a></li>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              <!-- /.box-header -->
              <div class="box-body ">
                    <p class="lead text-muted">Hallo admin!</p>

                    <h4>Start hier</h4>
                    <p><a href="#" class="btn btn-primary">Schrijf een artikel</a> </p>
              </div>
              <!-- /.box-body -->
            </div>
            <!-- /.box -->
